...
public class ManageQueueAdapter extends RecyclerView.Adapter<ManageQueueAdapter.ViewHolder> {
    ...
    public ManageQueueAdapter(Context context) {
    ...
    @NonNull
    @Override
    public ManageQueueAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_manage_queue, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ManageQueueAdapter.ViewHolder holder, int position) {
